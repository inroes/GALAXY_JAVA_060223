...
* The original package name 'pe.edu.galaxy.training.java.sb.ms.ms-negocio-gestion-clientes' is invalid and this project uses 'pe.edu.galaxy.training.java.sb.ms.msnegociogestionclientes' instead.
