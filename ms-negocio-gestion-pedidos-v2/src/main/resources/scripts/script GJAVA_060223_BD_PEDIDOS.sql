...
CREATE TABLE TBL_PEDIDO_DETALLE(
    PEDIDO_DETALLE_ID NUMERIC(6) NOT NULL PRIMARY KEY,
    PEDIDO_ID NUMERIC(6) REFERENCES TBL_PEDIDO(PEDIDO_ID),
...
INSERT INTO TBL_PEDIDO(PEDIDO_ID,CLIENTE_ID,GLOSA,TOTAL) VALUES(SEQ_PEDIDO.NEXTVAL, 1,'Pedido demo',7500);
COMMIT;

INSERT INTO TBL_PEDIDO(PEDIDO_ID,CLIENTE_ID,GLOSA,TOTAL) VALUES(SEQ_PEDIDO.NEXTVAL, 2,'Pedido demo 2',5000);
COMMIT;
...
INSERT INTO TBL_PEDIDO_DETALLE(PEDIDO_DETALLE_ID,PEDIDO_ID,PRODUCTO_ID,CANTIDAD,PRECIO,SUB_TOTAL) VALUES(SEQ_PEDIDO_DETALLE.NEXTVAL, 1,1,2,3000,6000);
INSERT INTO TBL_PEDIDO_DETALLE(PEDIDO_DETALLE_ID,PEDIDO_ID,PRODUCTO_ID,CANTIDAD,PRECIO,SUB_TOTAL) VALUES(SEQ_PEDIDO_DETALLE.NEXTVAL, 1,3,1,1500,1500);
INSERT INTO TBL_PEDIDO_DETALLE(PEDIDO_DETALLE_ID,PEDIDO_ID,PRODUCTO_ID,CANTIDAD,PRECIO,SUB_TOTAL) VALUES(SEQ_PEDIDO_DETALLE.NEXTVAL, 2,4,1,5000,5000);
